...
import com.floodrescue.report.shared.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = {
        ...
        "/api/reports/swagger-ui/**",
        "/api/reports/swagger-ui.html",
        "/api/reports/health",
        "/actuator/health",
        "/ws/**"
    };
    ...
    // PasswordEncoder removed — auth-service handles password hashing
}
