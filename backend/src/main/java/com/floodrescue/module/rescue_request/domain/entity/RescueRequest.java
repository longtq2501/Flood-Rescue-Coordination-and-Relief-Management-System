package com.floodrescue.module.rescue_request.domain.entity;
...
public class RescueRequest {
    ...
    private Long citizenId; // userId từ db_auth — KHÔNG dùng FK cross-schema
    ...
    private String addressText; // nhập thủ công nếu GPS lệch
    ...
    private Long coordinatorId; // userId coordinator xử lý
