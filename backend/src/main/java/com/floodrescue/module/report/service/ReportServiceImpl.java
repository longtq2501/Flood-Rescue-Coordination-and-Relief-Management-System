...
import com.floodrescue.module.report.dto.response.DashboardResponse.DailyRequestChartDto;
import com.floodrescue.module.report.dto.response.DashboardResponse.SummaryToday;
import com.floodrescue.module.report.dto.response.DashboardResponse.TeamRankingDto;
    ...
    private SummaryToday buildSummaryToday(LocalDate today) {
        return requestSnapshotRepo.findBySnapshotDate(today)
                .map(snapshot -> {
                    ...
                    // teamsActive = số team đang BUSY
                    int teamsActive = (int) rescueTeamRepository
                            .countByStatus(TeamStatus.BUSY);
                ...
                .orElseGet(() -> SummaryToday.builder()
                        ...
                        .teamsActive((int) rescueTeamRepository
                                .countByStatus(TeamStatus.BUSY))
