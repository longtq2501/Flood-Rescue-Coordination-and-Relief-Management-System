...
public class DispatchEventPublisher {
    ...
    /**
     * TODO Tuấn Anh: gọi trong AssignmentServiceImpl.assignTeam()
     * sau khi lưu Assignment vào DB thành công
     */
    ...
    /**
     * TODO Tuấn Anh: gọi trong AssignmentServiceImpl.completeAssignment()
     * sau khi đổi status COMPLETED
     */
    ...
    /**
     * TODO Tuấn Anh: gọi trong DispatchServiceImpl.updateLocation()
     * mỗi khi nhận GPS từ rescue team
     */
