...
public class DistributionController {
    ...
    public ResponseEntity<ApiResponse<DistributionResponse>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(distributionService.create(request, principal.getId()), 
                        "Phân phối thành công"));
    }

    @GetMapping
    public ResponseEntity<ApiResponse<Page<DistributionResponse>>> getAll(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(distributionService.getAll(pageable)));
    }
    ...
    public ResponseEntity<ApiResponse<Page<DistributionResponse>>> getByRequestId(
            ...
            Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(distributionService.getByRequestId(requestId, pageable)));
    }
}
